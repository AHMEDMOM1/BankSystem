...
public:
  ...
  static short Length(string S1) { return static_cast<short>(S1.length()); };

  short Length() { return static_cast<short>(_Value.length()); };
  ...
  static short CountWords(string S1) {
    ...
    while ((pos = static_cast<short>(S1.find(delim))) !=
           static_cast<short>(std::string::npos)) {
  ...
  string UpperAllString() { return _Value = UpperAllString(_Value); }
  ...
  static char InvertLetterCase(char char1) {
    return isupper(char1) ? static_cast<char>(tolower(char1))
                          : static_cast<char>(toupper(char1));
  }
  ...
  static bool IsVowel(char Ch1) {
    Ch1 = static_cast<char>(tolower(Ch1));
  ...
  static string TrimRight(string S1) {
    ...
    for (short i = static_cast<short>(S1.length() - 1); i >= 0; i--) {
      if (S1[i] != ' ') {
